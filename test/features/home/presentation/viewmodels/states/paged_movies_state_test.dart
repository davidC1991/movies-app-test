...
void main() {
  group('PagedMoviesState', () {
    test('fromPage construye la primera página', () {
      final PagedMoviesState state = PagedMoviesState.fromPage(pageResult([1, 2], page: 1, hasMore: true));
    ...
    test('startLoadingMore marca carga y limpia error', () {
      const PagedMoviesState base = PagedMoviesState(items: [], page: 1, hasMore: true, loadMoreError: true);
      final PagedMoviesState loading = base.startLoadingMore();
    ...
    test('appendPage anexa ítems y actualiza page/hasMore', () {
      final PagedMoviesState base = PagedMoviesState.fromPage(pageResult([1, 2], page: 1, hasMore: true));
      final PagedMoviesState next = base.appendPage(pageResult([3, 4], page: 2, hasMore: false));
    ...
    test('failLoadingMore marca error y detiene carga', () {
      const PagedMoviesState base = PagedMoviesState(items: [], page: 1, hasMore: true, isLoadingMore: true);
      final PagedMoviesState failed = base.failLoadingMore();
