...
void main() {
  group('MovieModel.fromJson', () {
    test('mapea campos snake_case y es-un Movie (LSP)', () {
      final MovieModel model = MovieModel.fromJson({
        'id': 1,
        'title': 'Película 1',
        'poster_path': '/p1.jpg',
        'vote_average': 7.5,
    ...
    test('poster_path nulo se tolera', () {
      final MovieModel model = MovieModel.fromJson({'id': 2, 'title': 'X', 'poster_path': null});
  ...
  group('MovieResponseModel.fromJson', () {
    test('mapea page, results y total_pages', () {
      final MovieResponseModel model = MovieResponseModel.fromJson(movieResponseJson(page: 2, totalPages: 5));
      expect(model.page, 2);
    ...
    test('total_pages ausente usa el default (1)', () {
      final MovieResponseModel model = MovieResponseModel.fromJson({'page': 1, 'results': []});
